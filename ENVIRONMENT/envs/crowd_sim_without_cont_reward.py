...
from ENVIRONMENT.envs.utils.state import tensor_to_joint_state, JointState
from ENVIRONMENT.envs.utils.action import ActionRot
...
class CrowdSim(gym.Env):
    ...
    def step(self, action, update=True):
        ...
        if self.global_time >= self.time_limit - 1:
            ...
            # alte pos zum ziel
            # neue dist zum ziel
            # delta * approaching reward = reward
