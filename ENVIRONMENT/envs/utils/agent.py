...
from ENVIRONMENT.envs.utils.action import ActionXY, ActionRot
from ENVIRONMENT.envs.utils.state import ObservableState, FullState
...
class Agent(object):
    ...
    def set(self, px, py, gx, gy, vx, vy, theta, radius=None, v_pref=None):
        self.px = px  # current position
        self.py = py
        self.sx = px  # start position
        self.sy = py
        self.gx = gx  # goal position
        self.gy = gy
        self.vx = vx  # velocity
        self.vy = vy
