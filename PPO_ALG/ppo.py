...
def ppo(actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
    ...
    ac = actor_critic(env.observation_space.shape, env.action_space, **ac_kwargs)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='ppo_8000_time_pen')
    parser.add_argument('--output_dir', type=str, default= 'data/ppo_for_eval')
