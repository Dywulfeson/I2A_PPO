...
from PPO_ALG.utils.test_policy import load_policy_ppo, load_policy_i2a, run_policy_blind
...
I2A = '/home/WIN-UNI-DUE/sosiharp/Python Files/MA_Final/I2A_WITH_PPO/data/i2a_comparison/i2a_gru_new_epo800_ste32000__envmodel_width_1_depth_5/i2a_gru_new_epo800_ste32000__envmodel_width_1_depth_5_s77'
...
# THIS SCRIPT IS VERY MESSY, IT COULD EASILY BE IMPROVED via config.json files in exp_folder, but i have no time left
...
render_episodes = [random.randint(0,episodes) for x in range(render_num)]
...
if ppo:
    ...
    encoder = ALTRolloutEncoder(env.observation_space.shape, encoder_size)
...
run_policy_blind(env, get_action, len, episodes, render, render_episodes)
